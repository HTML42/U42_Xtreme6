...
| ai generation/checkpoints | `docs/md_first.md` | `docs/release_qa.md`, `compiler/report_ai_generation.php`, generated QA reports |
| release/checkpoint/qa | `docs/release_qa.md` | `docs/md_first.md`, `compiler/release_gate.php`, generated QA reports |
